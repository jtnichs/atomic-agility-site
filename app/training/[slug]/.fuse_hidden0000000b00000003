...
const features = [
  {
    title: "Pre-Class Context Profile",
    body: "Complete our AI-powered interview before class. Your responses shape real examples and exercises used throughout the course — tailored to your organization and value streams.",
    icon: (
